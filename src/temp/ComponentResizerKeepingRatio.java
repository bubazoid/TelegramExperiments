 ...
 */
public class ComponentResizerKeepingRatio extends ComponentResizer {

   /* public ComponentResizerKeepingRatio(Insets dragInsets, Dimension snapSize, Window... components) {
        super(dragInsets, snapSize, components);
    }*/

    private IdentityHashMap<Component, Double> ratios;

    public ComponentResizerKeepingRatio(Component... components) {
        super(components);
    }
