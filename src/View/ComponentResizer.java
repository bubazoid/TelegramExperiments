...
/**
 * The View.ComponentResizer.ComponentResizer allows you to resize a component by dragging a border
 * of the component.
 */
public class ComponentResizer extends MouseAdapter {
    ...
    /**
     * Create a View.ComponentResizer.ComponentResizer.
     *
     * @param dragInsets Insets specifying which borders are eligible to be
     *                   resized.
    ...
    public void mouseDragged(MouseEvent e) {
        ...
        bounds.width = Math.round(bounds.height * ((float) ResManager.getBackground().getWidth() / ResManager.getBackground().getHeight()));
