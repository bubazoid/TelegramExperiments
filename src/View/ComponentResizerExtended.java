...
public class ComponentResizerExtended extends ComponentResizer {
   ...
   /* public View.ComponentResizerExtended(Insets dragInsets, Dimension snapSize, Window... components) {
    ...
    protected void changeBounds(Component source, int direction, Rectangle bounds, Point pressed, Point current) {
        ...
        if (policy == SIMPLE) {
            super.changeBounds(source, direction, bounds, pressed, current);
            return;
        }
